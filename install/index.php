...
<title>HRSALE - Ultimate HRM</title>
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-primary">
        <div class="panel-heading"> <strong class="">HRSALE - Ultimate HRM</strong> </div>
        ...
        <div class="panel-footer"><?php echo date('Y');?> &copy HRSALE - Ultimate HRM</div>
      </div>
    </div>
  </div>
</div>
